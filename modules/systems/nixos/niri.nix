  ...
  programs.niri.config = ''
    ...
    binds {
        ...
        XF86AudioRaiseVolume allow-when-locked=true {
            spawn-sh "playerctl --player=cmus,kew,spotify,mpd,audacious,firefox volume 0.05+"
        }
        ...
        XF86AudioPlay allow-when-locked=true {
            spawn-sh "playerctl --player=cmus,kew,spotify,mpd,audacious,firefox play-pause"
        }
        XF86AudioStop allow-when-locked=true {
            spawn-sh "playerctl --player=cmus,kew,spotify,mpd,audacious,firefox stop"
        }
        XF86AudioPrev allow-when-locked=true {
            spawn-sh "playerctl --player=cmus,kew,spotify,mpd,audacious,firefox previous"
        }
        XF86AudioNext allow-when-locked=true {
            spawn-sh "playerctl --player=cmus,kew,spotify,mpd,audacious,firefox next"
        }
