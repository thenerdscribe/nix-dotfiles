{ pkgs, lib, ... }:
let
  sqliteLibName = if pkgs.stdenv.hostPlatform.isDarwin then "libsqlite3.dylib" else "libsqlite3.so";
in
{
  home.file = {
    ".config/nvim/after/" = {
    ...
    plugins =
      ...
      [
        ...
        nvim-dap-ui
        {
          ...
          config = "let g:sqlite_clib_path = '${pkgs.sqlite.out}/lib/${sqliteLibName}'";
          type = "viml";
        }
        {
